    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            "Digite o nome: ", "Cadastro de Usuário",
             JOptionPane.PLAIN_MESSAGE); //Fazer uma pergunta com caixa de dialogo
             
             if (nome == null || nome.trim().isEmpty()){//Caso a pessoa não responda
             ...
             "Digite o sobrenome: ", "Cadastro de Usuário",
              ...
              if (sobrenome == null || sobrenome.trim().isEmpty()){
                ...
                String[] opcoesSexo = {"Masculino", "Feminino", "Outro"}; //Opçoes de resposta
                String sexo = (String) JOptionPane.showInputDialog(null,
                "Selecione o sexo", "Cadastro de Usuário",
                JOptionPane.PLAIN_MESSAGE, null, opcoesSexo, opcoesSexo[0]); //Escolher a resposta
...
//Salva o que foi respondido em um arquivo
    private static void salvarCadastro(String nome,  String sobrenome, String sexo, String RG, String CPF, String Anonasc){
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(FILE_PATH, true))){
            writer.write(nome + ", " + sobrenome + ", " + sexo + ", " +RG+ ", "+CPF+ ", "+Anonasc);
            writer.newLine();
            JOptionPane.showMessageDialog(null,
