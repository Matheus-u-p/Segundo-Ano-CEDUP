...
public static void main(String[] args) {
      ...
      endereco = var.next(); //Somente next porque senão ele acaba pulando o comando

      System.out.print("Digite seu salario: ");
      salario = var.nextFloat();

      System.out.print("Digite seu RG: ");
      rg = var.next(); //Somente next porque senão ele acaba pulando o comando
